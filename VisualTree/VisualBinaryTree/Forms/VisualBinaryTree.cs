...
{
    public partial class VisualBinaryTree : Form
    {
        ...
        public VisualBinaryTree(BinaryTreeNode _rootBinaryTree)
        {
            InitializeComponent();
            ...
            _graphicalTree = new TreeRenderBinaryTree();
            ResetUI();
            if (tmrDraw.Enabled)
            {
                GC.Collect();
          ...
          //  CheckScrollBars();
            ...
            _graphicalTree.Add(_rootBinaryTree);
            CheckScrollBars();
        }
        ...
        {
            if (!_graphicalTree.Add(txtValue.Text))
                return;
            CheckScrollBars();
